...
if($_SERVER["REQUEST_METHOD"]=='POST'){
   ...
   if(isset($row)){
     ...
     if($mail2==$mail){
      ...
      echo "The details you have entered is wrong please fill the right details";
    }
}
    ...
    <div style="margin:30px auto 30px 0px;">
        <form class="login-form" method="post">
            ...
            <div class="form-group">
                <input type="email" class="form-input" name="mail" placeholder="email@example.com" required>
            </div>
            <!--Password Input-->
            <div class="form-group">
            ...
            If you don't have an account? <a href="signup1.php">Sign Up</a></br></br>
            <a href="forgot1.php">Forgot Passsword</a>
            </div>
        </form>
